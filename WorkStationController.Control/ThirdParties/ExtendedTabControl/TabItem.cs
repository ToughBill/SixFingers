...
namespace WorkstationController.Control.ThirdParties.ExtendedTabControl
{
    ...
    public class TabItem : System.Windows.Controls.TabItem
    {
        static TabItem()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(WorkstationController.Control.ThirdParties.ExtendedTabControl.TabItem), new FrameworkPropertyMetadata(typeof(WorkstationController.Control.ThirdParties.ExtendedTabControl.TabItem)));
        }
