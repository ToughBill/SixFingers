...
{
    //var theDitiBox = layout.FindLabware(ditiBoxLabel);
    //if(theDitiBox == null)
    //    throw new NoLabwareException(ditiBoxLabel);
    //if(theDitiBox.TypeName != LabwareBuildInType.Diti1000.ToString())
    //    throw new Exception(string.Format("期望的器件类型是：{0},实际是{1}。",LabwareBuildInType.Diti1000.ToString(),theDitiBox.TypeName);
    //var position = theDitiBox.GetPosition(tipID);
    public class HardwareController : ILihaCommands
    {
        Layout layout;
        ...
        public void GetDiti(int tipID, string ditiBoxLabel)
        {
        ...
        public void DropDiti(string wasteLabel)
        {
