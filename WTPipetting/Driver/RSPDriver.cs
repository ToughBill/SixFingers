...
namespace MotorDriver
{
    ...
    public partial class RSPDriver
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                spMain.PortName = ConfigurationManager.AppSettings["RSPPortName"];
                //spMain.BaudRate = int.Parse(comboBox1.Text);
                spMain.BaudRate = int.Parse(ConfigurationManager.AppSettings["RSPBaudRate"]);
                try
                {
                    spMain.Open();
                }
        ...
        public void MoveLeftAbsolute(float x, float y, float z)
        {
            ComSend(string.Format("18PA {0} {1} {2}", x, y, z), false);
        }
        ...
        private void DetectLiquid(int nStart, int nSubMerge, int nEnd)
        {
            ComSend(string.Format("18ZX {0} {1} {2}", nStart, nSubMerge, nEnd), false);
        }
